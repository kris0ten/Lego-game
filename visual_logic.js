 ...
 * Wed Apr 17 2024 17:46:38 GMT+0530 (India Standard Time)
...
this.procedures["d1"] = d1;

var PROC = {
    "d1": d1,
};

var r, loc, p, t, g, x, s, sa, i, el1;
...
//
function d1(t) {
  objConstraintAddLimit(t, t, 'POS_Z', -8, 100, '', 0, 'LIMITDIST_ONSURFACE');
  registerOnDrag(t, false, [0,1,2], function() {}, function() {
    dragMove(t, 'XYZ', 'F~AM,l{*d=pu9wY*8:u+', '}6D-D$W$z7%o-dkD{7]+');
  }, function() {
    dictSet(loc, t, getObjTransform(t, false, 'position', 'xyz'));
  }, '}6D-D$W$z7%o-dkD{7]+');
}
...
r = 0;
changeVis('red', false);
addHTMLElement('button', 'btn', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'red', 'btn', false);
setHTMLElemStyle('height', '50px', 'btn', false);
setHTMLElemStyle('width', '50px', 'btn', false);
eventHTMLElem('click', 'btn', false, function(event) {
  t = cloneObject('red');
  r = (typeof r == 'number' ? r : 0) + 0;
  setObjTransform(t, false, 'position', [-30, -30, r], false);
  changeVis('red', true);
  d1(t);
});
registerOnDrag('red', false, [0,1,2], function() {}, function() {
  dragMove('red', 'XY', '3]Z*wr#J`A?#M,{={.A*', 'wCiY6/mvG0eDnFL)a]LA');
}, function() {}, 'wCiY6/mvG0eDnFL)a]LA');

loc = {};

p = 0;
changeVis('pink', false);
addHTMLElement('button', 'btn1', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'pink', 'btn1', false);
setHTMLElemStyle('height', '50px', 'btn1', false);
setHTMLElemStyle('width', '50px', 'btn1', false);
eventHTMLElem('click', 'btn1', false, function(event) {
  x = cloneObject('pink');
  p = (typeof p == 'number' ? p : 0) + 0;
  setObjTransform(x, false, 'position', [-40, -40, p], false);
  changeVis('pink', true);
  d1(x);
});
registerOnDrag('pink', false, [0,1,2], function() {}, function() {
  dragMove('pink', 'XY', ',8INKkfoAe?)STb.cRg!', 'sP`8-UBP22c9QugU~Re*');
}, function() {}, 'sP`8-UBP22c9QugU~Re*');

g = 0;
changeVis('green', false);
addHTMLElement('button', 'btn2', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'green', 'btn2', false);
...
eventHTMLElem('click', 'btn2', false, function(event) {
  s = cloneObject('green');
  g = (typeof g == 'number' ? g : 0) + 1.8;
  setObjTransform(s, false, 'position', [-50, -50, g], false);
  changeVis('green', true);
  d1(s);
});
registerOnDrag('green', false, [0,1,2], function() {}, function() {
  dragMove('green', 'XY', '!-T{5a/ZTfdvk#fkh.DZ', '(M|d?jzV4@mw:t|t-_~?');
}, function() {}, '(M|d?jzV4@mw:t|t-_~?');
addHTMLElement('button', 'save', 'TO', ['CONTAINER'], false);
eventHTMLElem('click', 'save', false, function(event) {
  downloadFile(loc, 'save.json ');
});
addHTMLElement('button', 'load', 'TO', ['CONTAINER'], false);
eventHTMLElem('click', 'load', false, function(event) {
  openFile(function() {
    sa = readJSON(_pGlob.openedFile);
    var i_list = typeof s == 'object' ? Object.keys(s) : [];
    for (var i_index in i_list) {
      i = i_list[i_index];
      if (textCount(i, 'green') == 1) {
        el1 = 'green';
      } else if (textCount(i, 'pink') == 1) {
        el1 = 'pink';
      } else {
        el1 = 'red';
      }
      x = cloneObject(el1);
      setObjTransform(el1, false, 'position', [dictGet(s, i)[0], dictGet(s, i)[1], dictGet(s, i)[2]], false);
      changeVis(el1, true);
      d1(el1);
    }
  });
